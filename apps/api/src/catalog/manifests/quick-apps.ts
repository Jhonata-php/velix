...
const APPS: QuickApp[] = [
  ...
  // guacd (usado só pra tunelar RDP/VNC) fica de fora — SSH e gestão de servidores funcionam sem ele.
  { slug: 'termix', name: 'Termix', description: 'Gerenciador de conexões SSH pelo navegador, com editor de arquivos e terminal.', category: 'network', image: 'ghcr.io/lukegus/termix:2.6.1', port: 8080, volumes: [['data', '/app/data']], docs: 'https://github.com/Termix-SSH/Termix' },
