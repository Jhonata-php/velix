...
/** Extraído da página de Configurações — cada seção agora é um componente
 * próprio, para caber numa aba sem a página inteira virar um arquivo só. */
        ...
        {account?.connected ? (
          ...
          <form onSubmit={handleConnect} className="flex gap-2">
            <input
              ...
              className="input"
            />
            <button type="submit" disabled={connecting} className="whitespace-nowrap btn-primary px-4 py-2 text-sm">
  ...
  return (
    <div className="border-t border-slate-200 px-4 py-3 dark:border-slate-700">
      ...
      <form onSubmit={handleAdd} className="mt-3 flex flex-wrap items-center gap-2">
        ...
        <button type="submit" disabled={saving} className="btn-primary px-3 py-2 text-xs">
