    ...
    <div className="card overflow-hidden p-0">
      ...
      <div className="p-4">
        ...
        <div
          ...
          className="h-80 overflow-y-auto rounded-lg border border-slate-200 bg-white p-3 font-mono text-[11.5px] leading-relaxed text-slate-800 dark:border-transparent dark:bg-slate-900 dark:text-slate-300"
        >
          {visible.length === 0 ? (
